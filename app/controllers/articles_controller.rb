class ArticlesController < ApplicationController
  ...
  before_action :authenticate_user!, except: %i[ index show report ]
  ...
  private
    ...
    def article_params
      params.expect(article: [ :title, :content, :reports_count, :archived, :user_id, :image ])
    end
